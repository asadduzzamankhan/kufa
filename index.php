...
session_start();
require_once "db.php";
 $select_query = "SELECT * FROM services WHERE status = 'active' ORDER BY id DESC";
...
$all_brand_from_database = mysqli_query($db_connect,$select_brand_query);
$onwer_name_select_query="SELECT settings_value FROM text_settings WHERE settings_name='owner_name'";
$owner_name_from_db=mysqli_query($db_connect,$onwer_name_select_query);

 $onwer_bio_select_query="SELECT settings_value FROM text_settings WHERE settings_name='owner_bio'";

$bio_from_db=mysqli_query($db_connect,$onwer_bio_select_query);
 $onwer_fb_select_query="SELECT settings_value FROM text_settings WHERE settings_name='fb_link'";

$fb_link_from_db=mysqli_query($db_connect,$onwer_fb_select_query);
                    ...
                    <div class="row align-items-center">
                        <div class="col-xl-7 col-lg-6">
                            <div class="banner-content">
                                ...
                                <h2 class="wow fadeInUp" data-wow-delay="0.4s"> <?=mysqli_fetch_assoc($owner_name_from_db)['settings_value']?></h2>
                                <p class="wow fadeInUp" data-wow-delay="0.6s"> <?=mysqli_fetch_assoc($bio_from_db)['settings_value']?></p>
                                <div class="banner-social wow fadeInUp" data-wow-delay="0.8s">
                                    <ul>
                                        ...
                                        <li class="<?=(mysqli_fetch_assoc($fb_link_from_db)['settings_value']) ?"":"d-none";?>"><a href="<?=mysqli_fetch_assoc($fb_link_from_db)['settings_value']?>"><i class="fab fa-facebook-f"></i></a></li>
					...
					<div class="row">
						...
						<div class="col-lg-4 col-md-6 ">
							<div class="icon_box_01 wow fadeInLeft" data-wow-delay="0.2s">
                               <div class="row">
                              <div class="col">
                                <i class="<?=$serv['service_icon']?> text-success"></i>
                                </div>
                                <div class="col-lg-10">
                       ...
                       ?>
                            ...
                            <div class="col-xl-2 col-lg-3 col-sm-6">
                                <div class="fact-box text-center mb-50">
                                    <div class="fact-icon text-success">
                                        <i class="<?=$port['portfolio_icon']?>"></i>
                                    </div>
                                    <div class="fact-content">
                                        <h2><span class="count"><?=$port['portfolio_number']?></span></h2>
                                        <span><?=$port['portfolio_title']?></span>
                                    </div>
                                </div>
                            </div>
            ...
            <div class="barnd-area pt-100 pb-100">
                <div class="container">
                    <div class="row brand-active">
                         ...
                         <?php foreach($all_brand_from_database as $brand):?>  
                        <div class="col-xl-2">
                            <div class="single-brand">
                                <img src="image/brand_image/<?=$brand['brand_image_name']?>" alt="img">
                            </div>
                        </div>
